...
// Controller for positive divisor
var positiveDivisorController = function ($scope, assessmentFactory) {
    ...
    $scope.calculatePositiveDivisors = function (isValid) {
        ...
        if (isValid) {
            ...
            assessmentFactory.calculatePositiveDivisors($scope.number)
    ...
    var errorCallback = function (response) {
        // Set error details
        setErrorDetails(true, "Oops!! Exception occurred while calculating divisor.");
        setResponseDetails("", false);
...
// Register Controller
positiveDivisorController.$inject = ['$scope', 'assessmentFactory'];
app.controller('positiveDivisorController', positiveDivisorController);